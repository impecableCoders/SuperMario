...
while True:
    ...
    if plyer_rect.bottom > screen_height and background == background2:
        plyer_rect.top = 0
        background = background1
    ...
    if plyer_rect.bottom > screen_height and background == background1:
    ...
    if plyer_rect.top < 0 and background !=background2 :
        plyer_rect.bottom = screen_height
        stein_rect.y = plyer_rect.centery-10
